                ...
                <div class="flex-1">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4 mt-1">
                                <span class="text-sm text-gray-500">
                                    Container: {{ $schedule->contentContainer->name }}
                                </span>
                                <span class="text-sm text-gray-500">
                                    Account: @{{ $schedule->instagramAccount->username }}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 flex items-center space-x-6 text-sm text-gray-600">
                        ...
                        <div class="flex items-center">
                            ...
                            Post {{ $schedule->current_post_index + 1 }} of {{ $schedule->contentContainer->posts->count() }}
                        </div>
                    </div>
                </div>
